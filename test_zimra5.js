...
// Structure matching Python: { deviceID, receipt }
const payload = {
  ...
  receipt: {
    ...
    receiptCounter: 1,
    receiptGlobalNo: 1,
    invoiceNo: "INV-TEST-006",
    receiptDate: "2026-05-21T13:50:00",
...
async function testPayload() {
  console.log('=== Testing Python-style payload: { deviceID, receipt } ===');
