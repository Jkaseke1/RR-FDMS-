...
// Try submitReceiptRequest as the receipt itself (no nested "receipt" wrapper)
const payload = {
  submitReceiptRequest: {
    receiptType: "FiscalInvoice",
    receiptDate: "2026-05-22T02:25:00",
    receiptGlobalNo: 1,
    receiptCounter: 1,
    receiptCurrency: "USD",
    receiptTotal: 100.44,
...
console.log('=== Test: submitReceiptRequest = receipt itself ===');
