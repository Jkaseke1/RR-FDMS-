...
// Test with submitReceiptRequest wrapper AND taxID in receiptLines
const payloadWithWrapper = {
  submitReceiptRequest: {
    ...
    receipt: {
      ...
      receiptCounter: 1,
      receiptGlobalNo: 1,
      invoiceNo: "INV-TEST-005",
      receiptDate: "2026-05-21T13:45:00",
...
async function testPayload() {
  console.log('=== Testing with submitReceiptRequest wrapper ===');
